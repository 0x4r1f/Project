...
const daysOfWeek = ["Sun", "Mon", "Tue", "Wed", "Thu", "Web", "Thu", "Fri", "Sat"];

daysOfWeek.forEach((dayName, ind) => {
...
const updateTime = () => {
    ...
    const formtedHours = hours % 12 || 12;
    time.innerText = `${formtedHours.toString().padStart(2, '0')}:${minutes.toString().padStart(2, '0')}:${secounds.toString().padStart(2, '0')} ${ampm}`;
